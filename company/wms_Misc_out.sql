/*
 ...
 Date: 11/09/2019 19:01:42
*/


-- ----------------------------
-- Table structure for wms_Misc_out
-- ----------------------------
IF EXISTS (SELECT * FROM sys.all_objects WHERE object_id = OBJECT_ID(N'[dbo].[wms_Misc_out]') AND type IN ('U'))
	DROP TABLE [dbo].[wms_Misc_out]
GO

CREATE TABLE [dbo].[wms_Misc_out] (
...
ALTER TABLE [dbo].[wms_Misc_out] SET (LOCK_ESCALATION = TABLE)
GO

EXEC sp_addextendedproperty
'MS_Description', N'出库单据号码',
'SCHEMA', N'dbo',
'TABLE', N'wms_Misc_out',
'COLUMN', N'doc_no'
GO
...
-- ----------------------------
-- Primary Key structure for table wms_Misc_out
-- ----------------------------
ALTER TABLE [dbo].[wms_Misc_out] ADD CONSTRAINT [PK__wms_mate__3213E83F5D3EB868] PRIMARY KEY CLUSTERED ([id])
