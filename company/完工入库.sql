/*
 ...
 Date: 16/07/2019 15:32:11
*/


-- ----------------------------
-- Table structure for wms_complete_in
-- ----------------------------
IF EXISTS (SELECT * FROM sys.all_objects WHERE object_id = OBJECT_ID(N'[dbo].[wms_complete_in]') AND type IN ('U'))
	DROP TABLE [dbo].[wms_complete_in]
GO

CREATE TABLE [dbo].[wms_complete_in] (
...
ALTER TABLE [dbo].[wms_complete_in] SET (LOCK_ESCALATION = TABLE)
GO

EXEC sp_addextendedproperty
'MS_Description', N'入库单据号码',
'SCHEMA', N'dbo',
'TABLE', N'wms_complete_in',
'COLUMN', N'doc_no'
GO
...
-- ----------------------------
-- Primary Key structure for table wms_complete_in
-- ----------------------------
ALTER TABLE [dbo].[wms_complete_in] ADD CONSTRAINT [PK__wms_mate__3213E83F5D3EB869] PRIMARY KEY CLUSTERED ([id])
