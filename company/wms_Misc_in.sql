/*
 ...
 Date: 11/09/2019 19:01:33
*/


-- ----------------------------
-- Table structure for wms_Misc_in
-- ----------------------------
IF EXISTS (SELECT * FROM sys.all_objects WHERE object_id = OBJECT_ID(N'[dbo].[wms_Misc_in]') AND type IN ('U'))
	DROP TABLE [dbo].[wms_Misc_in]
GO

CREATE TABLE [dbo].[wms_Misc_in] (
...
ALTER TABLE [dbo].[wms_Misc_in] SET (LOCK_ESCALATION = TABLE)
GO
...
-- ----------------------------
-- Primary Key structure for table wms_Misc_in
-- ----------------------------
ALTER TABLE [dbo].[wms_Misc_in] ADD CONSTRAINT [PK__wms_mate__3213E83F5D3EB867] PRIMARY KEY CLUSTERED ([id])
