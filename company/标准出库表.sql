...
-- ----------------------------
-- Table structure for wms_storge_out
-- ----------------------------
IF EXISTS (SELECT * FROM sys.all_objects WHERE object_id = OBJECT_ID(N'[dbo].[wms_storge_out]') AND type IN ('U'))
	DROP TABLE [dbo].[wms_storge_out]
GO
...
-- ----------------------------
-- Primary Key structure for table wms_storge_out
-- ----------------------------
ALTER TABLE [dbo].[wms_storge_out] ADD CONSTRAINT [PK__wms_stor__3213E83F056BCF54] PRIMARY KEY CLUSTERED ([id])
